...
import { hello } from '@rnds/design-system';
console.log(hello);
export const App = () => {
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx run-many -p StorybookApp -t build test lint
                </Text>
              </View>
